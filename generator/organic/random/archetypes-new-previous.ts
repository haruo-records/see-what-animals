...
/**
 * THE FIRST VERSION OF THE SIX, KEPT ONLY FOR COMPARISON.
 *
 * Not registered and never generated from. It exists so the redesign can be
 * shown beside what it replaced at the same seed, which is the only way to see
 * whether a change actually changed anything.
 *
...
export const PREVIOUS_NEW_ARCHETYPES: Archetype[] = [
  inverting,
  dispersed,
  emitting,
  paired,
